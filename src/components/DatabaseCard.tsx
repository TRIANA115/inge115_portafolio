...
export default function DatabaseCard() {
  return (
    <motion.div
      ...
      className="w-full p-6 rounded-2xl bg-gradient-to-br from-neutral-900/50 to-neutral-800/50 backdrop-blur-sm border border-white/10 hover:border-green-500/50 hover:bg-neutral-800/60 hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300 cursor-pointer"
    >
